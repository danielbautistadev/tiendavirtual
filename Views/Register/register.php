    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-capture"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="txtRePassword" placeholder="Repetir contraseña">
                                    </div>
                                </div>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?= base_url(); ?>/forgot">¿Olvídastes tu contraseña?</a>
                            </div>
                            <div class="text-center">
