            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-password-capture"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">¿Olvídastes tu contraseña?</h1>
                                    ...
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="txtPassword" aria-describedby="emailHelp"
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url(); ?>/register">Create una cuenta, es gratis!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url(); ?>/login">¿Tienes una cuenta? Inicia Sesión!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
